...
@XmlType(name = "TwinDataType", namespace = "http://kvs.pfr.com/iasmkgu-by-data/1.1.2", propOrder = {
    "snils",
    "birthPlace",
    "passportRF",
    "foreignPassport",
...
public class TwinDataType {
    ...
    @XmlElement(name = "Snils", namespace = "http://kvs.pfr.com/iasmkgu-by-data/1.1.2", required = true)
    protected String snils;
    @XmlElement(name = "BirthPlace", namespace = "http://kvs.pfr.com/iasmkgu-by-data/1.1.2", required = true)
